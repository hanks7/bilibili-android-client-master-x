...
public class ActivityCenterAdapter extends AbsRecyclerViewAdapter {
    private List<ActivityCenterInfo.ListBean> list;

    public ActivityCenterAdapter(RecyclerView recyclerView, List<ActivityCenterInfo.ListBean> list) {
        super(recyclerView);
        this.list = list;
    }
    ...
    public void onBindViewHolder(ClickableViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            ActivityCenterInfo.ListBean listBean = list.get(position);
