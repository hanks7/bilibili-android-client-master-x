...
import com.hanks.util.camera.CameraManager;
...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(frame.left - 10, frame.top - 10, frame.left, frame.top + 50, paint);
        canvas.drawRect(frame.left, frame.top - 10, frame.left + 50, frame.top, paint);
        canvas.drawRect(frame.right, frame.top - 10, frame.right + 10, frame.top + 50, paint);
        canvas.drawRect(frame.right - 50, frame.top - 10, frame.right, frame.top, paint);
        canvas.drawRect(frame.left - 10, frame.bottom - 50, frame.left, frame.bottom + 10, paint);
        canvas.drawRect(frame.left, frame.bottom, frame.left + 50, frame.bottom + 10, paint);
        canvas.drawRect(frame.right, frame.bottom - 50, frame.right + 10, frame.bottom + 10, paint);
        canvas.drawRect(frame.right - 50, frame.bottom, frame.right, frame.bottom + 10, paint);
...
////                        addModle += 10;
//
////                       myCanvas.drawRect(frame.left + 2, addModle - 1, frame.right - 1, addModle + 2, paint);
//                        if (addModle == frame.top + frame.height() -1){
//                            up = false;
//                        }
//                    }else {
//                        addModle -= 1;
