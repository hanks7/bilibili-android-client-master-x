 ...
 */
package com.hanks.util.activity;
...
import com.hanks.util.assit.AmbientLightManager;
import com.hanks.util.assit.BeepManager;
import com.hanks.util.camera.CameraManager;
import com.hanks.util.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        //防止按返回键，导致活动停止
        setResult(RESULT_OK, new Intent().putExtra(EXTRA_SCAN_RESULT, ""));
